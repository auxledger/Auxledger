...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "aux.ipc", false, filepath.Join(os.TempDir(), "aux.ipc")},
		{"data", "aux.ipc", false, "data/aux.ipc"},
		{"data", "./aux.ipc", false, "./aux.ipc"},
		{"data", "/aux.ipc", false, "/aux.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "aux.ipc", true, `\\.\pipe\aux.ipc`},
		{"data", "aux.ipc", true, `\\.\pipe\aux.ipc`},
		{"data", `\\.\pipe\aux.ipc`, true, `\\.\pipe\aux.ipc`},
	}
