...
The dashboard is a data visualizer integrated into aux, intended to collect and visualize useful information of an Ethereum node. It consists of two parts:
...
```
$ aux --dashboard --vmodule=dashboard=5
