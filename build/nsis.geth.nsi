...
# 1. install aux for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for aux
# 5. create aux, attach and uninstall start menu entries
...
function .onInit
  # make vars are global for all users since aux is installed global
