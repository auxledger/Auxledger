...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/aux.ipc",
			endpoint:    "/data/testnet/aux.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/aux.ipc",
			endpoint:    "/data/testnet/aux.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/aux.ipc",
			endpoint:    "/data/testnet/aux.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/aux.ipc",
			endpoint:    "/data/testnet/aux.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
